...
curl -sLO https://raw.githubusercontent.com/mask-dotcom/metasploit_in_termux/master/database.yml
...
cd $HOME
curl -sLO https://raw.githubusercontent.com/mask-dotcom/metasploit_in_termux/master/postgresql_ctl.sh
